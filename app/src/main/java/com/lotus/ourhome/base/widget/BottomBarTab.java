package com.lotus.ourhome.base.widget;
...
public class BottomBarTab extends FrameLayout {
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.app_main_dark));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.app_main_dark));
        } else {
