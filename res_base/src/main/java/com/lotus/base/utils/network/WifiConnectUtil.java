...
public class WifiConnectUtil {
	...
	private static final String TAG = WifiConnectUtil.class.getSimpleName();
	...
	public interface WifiConnectListener {
		...
		void connectResult(boolean result, String reason);
	}
	...
	private WifiConfiguration isExsits(String SSID) {
		...
		if(existingConfigs != null) for (WifiConfiguration existingConfig : existingConfigs) {
	...
	class ConnectRunnable implements Runnable {
		...
		public void run() {
			...
			long waitTime = 0;
			// 开启wifi功能需要一段时间，所以要等到wifi状态变成WIFI_STATE_ENABLED的时候才能执行下面的语句
